...
DEFAULT_TEAM_STRATEGY = "strongest_matchup"
...
def create_journey(
    ...
    *,
    ...
    return {
        ...
        "team_strategy": DEFAULT_TEAM_STRATEGY,
...
def _validate_journey(
    ...
    team_strategy = journey.get(
        "team_strategy",
        DEFAULT_TEAM_STRATEGY,
    )
    if (
        not isinstance(team_strategy, str)
        or team_strategy not in VALID_TEAM_STRATEGIES
    ):
        return "Stored Team Strategy is invalid."
